...
public class RegisterPanel extends javax.swing.JPanel {
	...
	private String validate = "2DxU";

	public RegisterPanel(JFrame mainFrame, UserCols ucs) {
		super();
	...
	private void initComponents() {
		...
		lab_showuser = new javax.swing.JLabel();
		...
		lab_welcome
				.setText("\u6b22\u8fce\u60a8\u52a0\u5165cdplane\u901a\u8baf\u5f55\u4e4b\u5bb6\uff01");

		lab_showuser.setText("(4-16\u4f4d\u6570\u5b57\u5b57\u6bcd)");
		...
		layout.setHorizontalGroup(layout
				...
				.addGroup(
						...
						layout.createSequentialGroup()
								...
								.addComponent(lab_welcome).addGap(51, 51, 51)));
	...
	private void btn_cancelActionPerformed(java.awt.event.ActionEvent evt) {
		...
		this.mainFrame.getContentPane().add(new LoginPanel(this.mainFrame, this.ucs));
	...
	private void btn_okActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if(check.checkUserName(username) && check.checkPasswd(passwd)
				...
				&& (validate.compareToIgnoreCase(lab_image.getText()) == 0)){
			if(ucs == null || this.ucs.get(username) == null){ // 判断该用户是否已经存在
	...
	private javax.swing.JLabel lab_showuser;
